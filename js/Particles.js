class Particles {
	...
	initPoints(discard) {
		var that = this;
		this.loader.load('shaders/particle.frag',function ( data ) {that.fShader =  data; that.runMoreIfDone(discard); },);
  		this.loader.load('shaders/particle.vert',function ( data ) {that.vShader =  data; that.runMoreIfDone(discard); },);
	}

	runMoreIfDone(discard) {
		this.numFilesLeft--;
